...
define(['jquery', 'admin.plugs'], function () {
    ...
    this.$body.on('click', '[data-file]', function () {
        ...
        var url = window.ROOT_URL + '/home.php/admin/plugs/upfile.html?mode=' + method + '&uptype=' + uptype + '&type=' + type + '&field=' + field;
    ...
    this.$body.on('click', '[data-icon]', function () {
        ...
        var url = window.ROOT_URL + '/home.php/admin/plugs/icon.html?field=' + field;
