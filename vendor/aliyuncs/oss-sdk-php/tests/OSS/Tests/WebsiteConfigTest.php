...
<IndexDocument>
<Suffix>index.index.html</Suffix>
</IndexDocument>
<ErrorDocument>
...
BBBB;
    ...
    {
        $websiteConfig = new WebsiteConfig("index.index.html", "errorDocument.html");
        $this->assertEquals('index.index.html', $websiteConfig->getIndexDocument());
