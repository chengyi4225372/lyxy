...
//        $chapter_id = db($this->chapter)->where("course_id","=",$cid)->column("id");
...
//        }
    ...
    private function _chapter()
    {
        ...
        return db($this->chapter)->where(['is_deleted' => '0','status'=>'1','course_id'=>$cid])->select();
    }
