...
// +----------------------------------------------------------------------
Route::rule('micro/index','index/micro/index');
Route::rule('','index/index/index');
Route::rule('course/index','index/course/index');
Route::rule('camp/index','index/camp/index');
Route::rule('open/index','index/open/index');
Route::rule('about/index','index/about/index');
Route::rule('material/index','index/material/index');
/*  测试环境禁止操作路由绑定 */
think\Route::post([
